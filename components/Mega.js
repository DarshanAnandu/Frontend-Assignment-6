                    ...
                    >
                        ...
                        >
                            ...
                            <nav className="navbar_dropdown-list w-dropdown-list">
                                ...
                                <a href="/avatars" className="navbar_dropdown-link w-dropdown-link">
                                    AI Avatars
                                </a>
                                <a
                                    href="/video-template"
            ...
            >
                <div id="cookiesPopUp" className="cookies-pop-up">
                    ...
                    <p className="cookies-para">
                        In addition to cookies that are essential to operate our website, we use
                        cookies and similar technologies to analyze traffic, personalize content
                        and ads, to provide social media features and to improve our products
                        and services. These technologies are set by third parties, including our
                        social media, advertising and analytics partners. Please read our{" "}
                    ...
                    >
                        ...
                        <div id="AdsCheckBtn" data-check="unchecked" className="cookies-select">
                            <div className="cookies-select-icon">
                                <div className="cookies-select-checkbox unchecked">
                                    <img
                                        src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/655339422f2b2d24a083acd2_checkbox-icon.svg"
                                            ...
                                            <div className="create_card_details">
                                                <div>
                                                    <h3 className="create_cred_head">
                                                        Sales outreach
                                                        <br />
                                                        <span className="light-purple_span">that converts</span>
                                                    </h3>
                                            ...
                                            <div className="create_card_details">
                                                <div>
                                                    <h3 className="create_cred_head">
                                                        Content marketing
                                                        <br />‍
                                                        <span className="light-purple_span">that engage</span>
                                                    </h3>
                                                    <div className="create_cred_info">
...
"
                                        ...
                                        <div className="create_video_card">
                                            <div className="relative create_video_wrap">
                                                ...
                                                <div className="create_video_wrap w-embed">
                                                    <video
                                                        className="muted-video"
                                                        src="https://resource.heygencdn.com/homepage/usecase_lnd2.mp4"
                                                        type="video/mp4"
                                                        muted=""
                                                        autoPlay=""
                                                        loop=""
                            ...
                            <div className="div-block-273">
                                ...
                                <div className="how_video">
                                    <div className="how_video_wrap w-embed">
                                        <video
                                            className="muted-video"
                                            src="https://resource.heygencdn.com/homepage/howitworks_new.mp4"
                                            type="video/mp4"
                                            muted=""
                                            autoPlay=""
                                            loop=""
                        ...
                        <div className="how_cards">
                            ...
                            >
                                ...
                                <img
                                    ...
                                    sizes="(max-width: 479px) 236px, (max-width: 991px) 293px, (max-width: 1439px) 23vw, 294.6640625px"
                                    alt=""
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p className="how_card_para">
                                        Choose from a collection of high-quality voices or record your
                                        own.
                                    </p>
                                </div>
                                <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p className="how_card_para">
                                        Select from an extensive array of ready-to-use templates for any
                                        scenario, or begin with a clean slate.
                                    </p>
                                </div>
                                <div
                                ...
                                >
                                    <div className="how_3_scrolling_row_wrap">
                                        <div className="how_3_scrolling_row">
                                            <img
                                                ...
                                                alt=""
                                                sizes="(max-width: 479px) 100vw, 535.5703125px"
                                    ...
                                    <div className="how_3_scrolling_row_wrap">
                                        <div className="how_3_scrolling_row">
                                            <img
                                                src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65677c6057c6907c190fdbbb_3row3.webp"
                                                alt=""
                                                sizes="(max-width: 479px) 100vw, 535.5703125px"
                                                srcSet="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65677c6057c6907c190fdbbb_3row3-p-500.webp 500w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65677c6057c6907c190fdbbb_3row3-p-800.webp 800w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65677c6057c6907c190fdbbb_3row3.webp 1064w"
                                                className="how_3_scrolling_img"
                                            />
                                            <img
                                                src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65677c6057c6907c190fdbbb_3row3.webp"
                            ...
                            <div className="avatars_head">
                                <div className="section_head_padding_2">
                                    <div className="section_head_padding">
                                        <h2 className="heygen_section_heading is-center">AI avatars</h2>
                                ...
                                <div className="avatars_row_wrap">
                                    <div className="avatars_row row2">
                                        <div className="avatars_row_items">
                                            <div className="avatar_card">
                                                <img
                                                    src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/656b3cdad387405af1273a30_15.webp"
                                                    alt=""
                                                />
                                                <div className="avatar_btn_wrap">
                                                    <a
                                        ...
                                        >
                                            ...
                                            <defs>
                                                ...
                                                >
                                                    ...
                                                    <stop offset={1} stopColor="#7559FF" stopOpacity={0} />
                                                </linearGradient>
                                            </defs>
                                        </svg>
                                    </div>
                                ...
                                <div className="avatar_video_item">
                                    ...
                                    <div className="avatar_video">
                                        <div className="avatar_video_wrap w-embed">
                                            <video
                                                className="muted-video"
                                                src="https://resource.heygencdn.com/homepage/AIavatar_studio2.mp4"
                                                type="video/mp4"
                                                muted=""
                                                autoPlay=""
                                                loop=""
                            ...
                            <div className="voices_wrap">
                                    ...
                                    <div className="section_head_padding_2">
                                        <div className="section_head_padding voice">
                                            ...
                                            <p className="heygen_para">
                                                ...
                                                from our AI-Driven text reader, infusing human-like
                                                intonation and inflections with exceptional accuracy.
                                            </p>
                                        </div>
                                ...
                                >
                                    <div className="voices_slider shadows_2 voice-fixed1">
                                        <div className="voice_slider_heading_div">
                                            <h3 className="voices_slider_heading">
                                                <span className="purple-span">300+</span>
                                                voices
                                            </h3>
                                    ...
                                    <div className="voices_slider shadows_2 voice-fixed2">
                                        <div className="voice_slider_heading_div">
                                            <h3 className="voices_slider_heading">
                                                <span className="purple-span">40+</span>
                                                languages
                                            </h3>
                                            <div className="slider_control_wrap">
                                                <div
                            ...
                            <div className="feature_gaps">
                                    ...
                                    >
                                        ...
                                        <div className="feature_content_wrap">
                                            ...
                                            <p className="feature_card_para font-white">
                                                ...
                                                solution that clones your natural speaking voice and style
                                                for seamless delivery in other languages.
                                            </p>
                                            <a
                                                href="/video-translate"
                                                className="button_primary w-inline-block"
                                    ...
                                    >
                                        ...
                                        <div className="div-block-302">
                                            <img
                                                ...
                                                loading="lazy"
                                                sizes="(max-width: 479px) 100vw, (max-width: 991px) 94vw, (max-width: 1439px) 46vw, 574px"
                                ...
                                <div className="feature_row_grid_2">
                                    <div className="feature_card_3">
                                        <div>
                                            <h3 className="feature_card_head">ChatGPT script writer</h3>
                                            <p className="feature_card_para">
                                    ...
                                    <div className="feature_card_4">
                                        <div className="feature_content_wrap">
                                            <h3 className="feature_card_head font-white">AI outfits</h3>
                                ...
                                <div className="feature_row_grid_4">
                                    <div className="feature_card_5">
                                        <div className="feature_content_wrap">
                                            <h3 className="feature_card_head font-white">Integrations</h3>
                                            <p className="feature_card_para is-white">
                                        ...
                                        <div id="popular-slider" className="splide">
                                            <div className="splide__track">
                                                <div className="splide__list feature_template_card_wrap">
                                                    ...
                                                    >
                                                        <img
                                                            src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed649aac7534b98eb3b_Slide%2016_9%20-%2014%20(1).webp"
                                                            loading="lazy"
                                                            sizes="(max-width: 479px) 76vw, 313px"
                                                            srcSet="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed649aac7534b98eb3b_Slide%2016_9%20-%2014%20(1)-p-500.webp 500w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed649aac7534b98eb3b_Slide%2016_9%20-%2014%20(1)-p-800.webp 800w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed649aac7534b98eb3b_Slide%2016_9%20-%2014%20(1)-p-1080.webp 1080w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed649aac7534b98eb3b_Slide%2016_9%20-%2014%20(1)-p-1600.webp 1600w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed649aac7534b98eb3b_Slide%2016_9%20-%2014%20(1)-p-2000.webp 2000w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed649aac7534b98eb3b_Slide%2016_9%20-%2014%20(1)-p-2600.webp 2600w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed649aac7534b98eb3b_Slide%2016_9%20-%2014%20(1)-p-3200.webp 3200w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed649aac7534b98eb3b_Slide%2016_9%20-%2014%20(1).webp 5760w"
                                                            alt=""
                                                            className="full-width-img _100-height"
                                                        />
                                                    </a>
                                        ...
                                        <div id="advertising-slider" className="splide">
                                            <div className="splide__track">
                                                <div className="splide__list feature_template_card_wrap is-hidden">
                                                    ...
                                                    >
                                                        <img
                                                            src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed442421befbf8e4e06_Diversity%2C%20Equity%2C%20and%20Inclusion%20(2).webp"
                                                            loading="lazy"
                                                            sizes="100vw"
                                                            srcSet="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed442421befbf8e4e06_Diversity%2C%20Equity%2C%20and%20Inclusion%20(2)-p-500.webp 500w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed442421befbf8e4e06_Diversity%2C%20Equity%2C%20and%20Inclusion%20(2)-p-800.webp 800w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed442421befbf8e4e06_Diversity%2C%20Equity%2C%20and%20Inclusion%20(2)-p-1080.webp 1080w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed442421befbf8e4e06_Diversity%2C%20Equity%2C%20and%20Inclusion%20(2)-p-1600.webp 1600w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed442421befbf8e4e06_Diversity%2C%20Equity%2C%20and%20Inclusion%20(2)-p-2000.webp 2000w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed442421befbf8e4e06_Diversity%2C%20Equity%2C%20and%20Inclusion%20(2)-p-2600.webp 2600w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed442421befbf8e4e06_Diversity%2C%20Equity%2C%20and%20Inclusion%20(2)-p-3200.webp 3200w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65661ed442421befbf8e4e06_Diversity%2C%20Equity%2C%20and%20Inclusion%20(2).webp 5760w"
                                                            alt=""
                                                            className="full-width-img _100-height"
                                                        />
                                                    </a>
            ...
            <div>
                <div className="home_showcase_pop-up-1">
                        ...
                        <div className="home_show-case-pop-up-body">
                            <div className="hori-between-div">
                                ...
                                <img
                                    ...
                                    loading="lazy"
                                    data-w-id="2db8751d-f364-3e57-3465-4a19bf5cfaae"
                                    alt=""
                            ...
                            <div className="home-showcase-video">
                                ...
                                >
                                    <iframe
                                        src="https://www.youtube.com/embed/PNGYQUR4R9g?rel=0&controls=1&autoplay=0&mute=0&start=0"
                                        frameBorder={0}
                                        style={{
                                            position: "absolute",
                                            left: 0,
                            ...
                            <div className="flex-horizontal-center items-center gap-16">
                                <a
                                    href="https://www.youtube.com/watch?v=PNGYQUR4R9g"
                                    target="_blank"
                                    className="btn small-w-120 w-button"
                                >
                                    view post
                                </a>
                                <a
                                    href="https://app.heygen.com/login"
                                    target="_blank"
                                    className="btn small-w-120 fill w-button"
                                >
                                    try now
                                </a>
                            </div>
                ...
                <div className="home_showcase_pop-up-2">
                    <div className="showcase-pop-up-container">
                        <div className="home_show-case-pop-up-body">
                            <div className="hori-between-div">
                                <div className="home-show-case-user" />
                                <img
                                    src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/63fdcbe48aa020540d4936da_close.svg"
                                    loading="lazy"
                                    data-w-id="2dd3de0d-4a98-8aad-d0c0-30f525dd1d62"
                                    alt=""
                                    className="showcase-close-btn-home"
                                />
                            </div>
                            <div className="home-showcase-video">
                                <div className="w-embed">
                                    <video
                                        src="https://video.twimg.com/amplify_video/1710485687391416320/vid/avc1/1280x720/O0C_o-VQgqktLBax.mp4?tag=14"
                                        type="video/mp4"
                            ...
                            <div className="flex-horizontal-center items-center gap-16">
                                <a
                                    href="https://twitter.com/mrjonfinger/status/1710485964307706035"
                                    target="_blank"
                                    className="btn small-w-120 w-button"
                                >
                                    view post
                ...
                <div className="home_showcase_pop-up-3">
                    <div className="showcase-pop-up-container">
                        <div className="home_show-case-pop-up-body">
                            <div className="hori-between-div">
                                <div className="home-show-case-user" />
                                <img
                                    src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/63fdcbe48aa020540d4936da_close.svg"
                                    loading="lazy"
                                    data-w-id="cef7841b-e035-c119-be29-6d1a59448595"
                                    alt=""
                                    className="showcase-close-btn-home"
                                />
                            </div>
                            <div className="home-showcase-video">
                                ...
                                >
                                    <iframe
                                        src="https://www.youtube.com/embed/rjVTe_5HXow?rel=0&controls=1&autoplay=0&mute=0&start=0"
                                        frameBorder={0}
                                        style={{
                                            position: "absolute",
                                            left: 0,
                                        ...
                                        allow="autoplay; encrypted-media"
                                        allowFullScreen=""
                                        title="My New Voice Clone Speaks Every Language"
                                    />
                                </div>
                            </div>
                            <div className="flex-horizontal-center items-center gap-16">
                                <a
                                    href="https://www.youtube.com/embed/rjVTe_5HXow"
                                    target="_blank"
                                    className="btn small-w-120 w-button"
                                >
                                    view post
                ...
                <div className="home_showcase_pop-up-4">
                    <div className="showcase-pop-up-container">
                        <div className="home_show-case-pop-up-body">
                            <div className="hori-between-div">
                                <div className="home-show-case-user" />
                                <img
                                    src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/63fdcbe48aa020540d4936da_close.svg"
                                    loading="lazy"
                                    data-w-id="ddb4e019-02b2-0a9f-95ae-5abd864603b5"
                                    alt=""
                                    className="showcase-close-btn-home"
                                />
                            </div>
                            <div className="home-showcase-video">
                                <div className="w-embed">
                                    <video
                                        src="https://video.twimg.com/ext_tw_video/1706360392056713216/pu/vid/avc1/1920x1080/VLb_U2LCs2EdXWAX.mp4?tag=14"
                                        type="video/mp4"
                                        className="showcase-video"
                                        controls=""
                                    />
                            ...
                            <div className="flex-horizontal-center items-center gap-16">
                                <a
                                    href="https://twitter.com/bramk/status/1706362316722208773?s=20"
                                    target="_blank"
                                    className="btn small-w-120 w-button"
                                >
                                    view post
                ...
                <div className="home_showcase_pop-up-5">
                    <div className="showcase-pop-up-container">
                        <div className="home_show-case-pop-up-body">
                            <div className="hori-between-div">
                                <div className="home-show-case-user" />
                                <img
                                    src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/63fdcbe48aa020540d4936da_close.svg"
                                    loading="lazy"
                                    data-w-id="a130ce12-8b57-19aa-1fc6-4a6da381d9b9"
                                    alt=""
                                    className="showcase-close-btn-home"
                                />
                            </div>
                            <div className="home-showcase-video">
                                <div className="w-embed">
                                    <video
                                        src="https://video.twimg.com/ext_tw_video/1719736945545285632/pu/vid/avc1/1280x720/wlzm1ycKrA4jpS5C.mp4?tag=12"
                                        type="video/mp4"
                                        className="showcase-video"
                                        controls=""
                                    />
                            ...
                            <div className="flex-horizontal-center items-center gap-16">
                                <a
                                    href="https://twitter.com/AlexSprogis/status/1719737053166887392?s=20"
                                    target="_blank"
                                    className="btn small-w-120 w-button"
                                >
                                    view post
                ...
                <div className="home_showcase_pop-up-6">
                    <div className="showcase-pop-up-container">
                        <div className="home_show-case-pop-up-body">
                            <div className="hori-between-div">
                                <div className="home-show-case-user" />
                                <img
                                    src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/63fdcbe48aa020540d4936da_close.svg"
                                    loading="lazy"
                                    data-w-id="0a76dca0-08c1-68cb-daca-32ea3f68ed86"
                                    alt=""
                                    className="showcase-close-btn-home"
                                />
                            </div>
                            <div className="home-showcase-video">
                                ...
                                >
                                    <iframe
                                        src="https://www.youtube.com/embed/22EYNbO0pjc?rel=0&controls=1&autoplay=0&mute=0&start=0"
                                        frameBorder={0}
                                        style={{
                                            position: "absolute",
                                            left: 0,
                                        ...
                                        allow="autoplay; encrypted-media"
                                        allowFullScreen=""
                                        title="The Future of Translation with HeyGen - AI Translation with Lip Syncing"
                                    />
                                </div>
                            </div>
                            <div className="flex-horizontal-center items-center gap-16">
                                <a
                                    href="https://www.youtube.com/watch?v=22EYNbO0pjc"
                                    target="_blank"
                                    className="btn small-w-120 w-button"
                                >
                                    view post
                ...
                <div className="home_showcase_pop-up-7">
                    <div className="showcase-pop-up-container">
                        <div className="home_show-case-pop-up-body">
                            <div className="hori-between-div">
                                <div className="home-show-case-user" />
                                <img
                                    src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/63fdcbe48aa020540d4936da_close.svg"
                                    loading="lazy"
                                    data-w-id="0603d1c1-2cda-9b55-bd61-ad505fd18ccd"
                                    alt=""
                                    className="showcase-close-btn-home"
                                />
                            </div>
                            ...
                            <div className="flex-horizontal-center items-center gap-16">
                                <a
                                    href="https://www.instagram.com/reel/CzW5a3Br9T8/?igshid=MThmMWhndmxiemdwYw%3D%3D"
                                    target="_blank"
                                    className="btn small-w-120 w-button"
                                >
                                    view post
                ...
                <div className="w-layout-blockcontainer heygen_container w-container">
                    <div className="safety_wrap">
                        <div className="safety_grid">
                            <div
                                id="w-node-_5bcdc095-7f6b-9bdc-b0fc-99c300d65640-8c4e74c2"
                                className="div-block-318"
                            >
                                <div className="btn_locked_icon w-embed">
                                    <svg
                                        viewBox="0 0 48 48"
                                        fill="none"
                                        xmlns="http://www.w3.org/2000/svg"
                                ...
                                <h2 className="heading-136">
                                    Safety at the core of our technology
                                </h2>
                            </div>
                            <div
                                id="w-node-d10d8e53-81a2-68bb-9dac-51a3246a0968-8c4e74c2"
                                className="div-block-316"
                            >
                                <div className="satety-text-text">
                                    <div>
                                        At HeyGen, security isn 't just a consideration—it 's a
                                        commitment. That 's why we 're proud to be SOC 2 compliant, an
                                        industry standard for data protection.
                                        <br />
                                        Our AI video platform is built with your privacy and protection
                                        in mind, so you can trust us with your valuable data.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="safety_line" />
                        <div className="safety_check_list">
                            <div
                                id="w-node-_7bb1b349-0c6d-1d42-9bf4-d8fda696e715-8c4e74c2"
                                className="safety_card_div"
                            >
                                <div
                                    id="w-node-da546e62-787a-e748-3ccf-10f18c5313b1-8c4e74c2"
                                    className="w-embed"
                                >
                                    <svg
                                        width={28}
                                    ...
                                    >
                                        <path
                                            d="M4.92543 4.92544C7.24655 2.60436 10.4565 1.16666 14 1.16666C17.5434 1.16666 20.7534 2.60436 23.0745 4.92545C25.3956 7.24657 26.8333 10.4565 26.8333 14C26.8333 17.5435 25.3956 20.7534 23.0745 23.0745C20.7534 25.3956 17.5434 26.8333 14 26.8333C10.4565 26.8333 7.24655 25.3956 4.92542 23.0745C2.60433 20.7534 1.16663 17.5435 1.16663 14C1.16663 10.4565 2.60434 7.24657 4.92543 4.92544Z"
                                            fill="#00BF8F"
                                        />
                                        <path
                                            d="M12.0086 18.3251C12.4642 18.7807 13.2029 18.7807 13.6585 18.3251L20.7763 11.2073C21.1668 10.8167 21.1668 10.1836 20.7763 9.79306L20.5406 9.55736C20.1501 9.16683 19.5169 9.16683 19.1264 9.55736L13.5406 15.1431C13.1501 15.5337 12.5169 15.5337 12.1264 15.1431L10.0406 13.0574C9.65009 12.6668 9.01693 12.6668 8.6264 13.0574L8.3907 13.2931C8.00018 13.6836 8.00018 14.3167 8.3907 14.7073L12.0086 18.3251Z"
                                            fill="white"
                                        />
                                    </svg>
                                </div>
                                <div id="w-node-_26fa7b55-1671-9576-8151-6b2f59a76534-8c4e74c2">
                                    <h3 className="safety_head">Ethics statement</h3>
                                    <p className="safety_para">
                                        Discover our ethical approach to AI, emphasizing acceptable use
                                        and transparency.{" "}
                                        <a href="/ethics" className="link-underline-white">
                                            View more.
                                        </a>
                                    </p>
                                </div>
                            ...
                            <div
                                id="w-node-b8e9acef-7b55-0f40-d969-7f10daaad710-8c4e74c2"
                                className="safety_card_div"
                            >
                                <div
                                    id="w-node-abe7aad0-eb20-2263-d0f2-878ac780f10a-8c4e74c2"
                                    className="w-embed"
                                >
                                    <svg
                                        width={28}
                                ...
                                <div id="w-node-b8e9acef-7b55-0f40-d969-7f10daaad712-8c4e74c2">
                                    <h3 className="safety_head">Security portal</h3>
                                    <p className="safety_para">
                                        Learn how we protect your data and secure our AI technology.
                                        &nbsp;
                                        <a
                                            href="https://security.heygen.com"
                                            target="_blank"
                            ...
                            <div
                                id="w-node-dd518435-c1ba-4251-ba7c-4aa04f3e0f0d-8c4e74c2"
                                className="safety_card_div"
                            >
                                <div
                                    id="w-node-_8abf1cb6-acf7-b887-dca0-eb36784f41e4-8c4e74c2"
                                    className="w-embed"
                                >
                                    <svg
                                        width={28}
                                ...
                                <div id="w-node-dd518435-c1ba-4251-ba7c-4aa04f3e0f0f-8c4e74c2">
                                    <h3 className="safety_head">Privacy policy</h3>
                                    <p className="safety_para">
                                        See how we respect and protect your data in compliance with
                                        industry standards. &nbsp;
                                        <a href="/policy" className="link-underline-white">
                                            View more.
                                        </a>
                                    </p>
                                </div>
                            ...
                            <div
                                id="w-node-_6d122d59-dde9-5336-1cb5-449165ebb65b-8c4e74c2"
                                className="safety_card_div"
                            >
                                <div
                                    id="w-node-_4395e1fa-3676-9701-09c0-3d3f475611ee-8c4e74c2"
                                    className="w-embed"
                                >
                                    <svg
                                        width={28}
                                ...
                                <div id="w-node-_6d122d59-dde9-5336-1cb5-449165ebb65d-8c4e74c2">
                                    <h3 className="safety_head">Content moderation</h3>
                                    <p className="safety_para">
                                        Find out how we promote a safe, respectful digital environment.
                                        &nbsp;
                                        <a href="/moderation-policy" className="link-underline-white">
                                            View more.
                                        </a>
                                    </p>
                                </div>
                ...
                <section>
                        ...
                        <div className="flex-vertical-center">
                            <div className="div-block-324">
                                <div className="div-block-322">
                                    <h2 className="heygen_section_heading is-center is-black">
                                        A <span className="purple-span">beloved</span>
                                        industry leader
                                    </h2>
                                    <p className="heygen_para">
                                        Over 15,000 5-star reviews from across the internet
                                    </p>
                                </div>
                                <div className="div-block-323">
                                    <img
                                        ...
                                        loading="lazy"
                                        id="w-node-_58b9d21f-be59-888d-b5fe-0bbec8dcf005-c8dceff8"
                                        alt=""
                                        className="full-width-img"
                                    />
                                    <img
                                        ...
                                        loading="lazy"
                                        id="w-node-_58b9d21f-be59-888d-b5fe-0bbec8dcf006-c8dceff8"
                                        alt=""
                                        className="full-width-img"
                                    />
                                    <img
                                        ...
                                        loading="lazy"
                                        id="w-node-_58b9d21f-be59-888d-b5fe-0bbec8dcf007-c8dceff8"
                                        alt=""
                                        className="full-width-img"
                                    />
                                    <img
                                        ...
                                        loading="lazy"
                                        id="w-node-_58b9d21f-be59-888d-b5fe-0bbec8dcf008-c8dceff8"
                                        alt=""
                                        className="full-width-img"
                                    />
                                    <img
                                        ...
                                        loading="lazy"
                                        id="w-node-_58b9d21f-be59-888d-b5fe-0bbec8dcf009-c8dceff8"
                                        alt=""
                                        className="full-width-img"
                                    />
                                    <img
                                        ...
                                        loading="lazy"
                                        id="w-node-_58b9d21f-be59-888d-b5fe-0bbec8dcf00a-c8dceff8"
                                        alt=""
                                        className="full-width-img"
                                    />
                                    <img
                                        ...
                                        loading="lazy"
                                        id="w-node-_58b9d21f-be59-888d-b5fe-0bbec8dcf00b-c8dceff8"
                                        alt=""
                                        className="full-width-img"
                                    />
                                </div>
                    ...
                    <div className="reviews_wrapper">
                        <div className="reviews_row1_wrap">
                            <div className="reviews_row_1">
                                <div className="reviews_card">
                                    <div className="w-layout-hflex reviews_starts">
                                        <div className="btn_stars_icon w-embed">
                                            <svg
                                                width={24}
                                                height={22}
                                                viewBox="0 0 24 22"
                                    ...
                                    <div className="text-block-93">
                                        "Power of creativity in business "
                                    </div>
                                    <p className="paragraph-22">
                                        Heygen serves as a valuable resource for businesses aiming to
                                        establish a strong online presence and cultivate a unique
                                        business identity.
                                    </p>
                                    <div className="hori-between-div review">
                                        <img
                                            src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65672407d2db8d0e343ad5a8_image%201.webp"
                                            alt=""
                                            className="review_profile"
                                        />
                                        <div className="text-col3">
                                            <div className="review_name">Ray S.</div>
                                ...
                                <div className="reviews_card">
                                    ...
                                    <div className="text-block-93">
                                        "Your Personal Stage Director for Stellar Videos "
                                    </div>
                                    <p className="paragraph-22">
                                        It 's like having a magic wand for video creation. It 's not
                                        just a tool; it 's more like a backstage crew always ready to
                                        put on a show.
                                    </p>
                                    <div className="hori-between-div review">
                                        <img
                                        ...
                                        />
                                        <div className="text-col3">
                                            <div className="review_name">Bently H.</div>
                                            <div className="review_info">Mid-Market(51-1000 emp.)</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="reviews_card">
                                    ...
                                    <div className="text-block-93">
                                        "Fantastic tool for creating AI Videos "
                                    </div>
                                    <p className="paragraph-22">
                                        Whether you want to make a video for your business, your social
                                        media, or your personal project, HeyGen can help you turn your
                                        ideas into reality.
                                    </p>
                                    <div className="hori-between-div review">
                                        <img
                                            src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65672407bd51181857e1db7d_image%208.webp"
                                            alt=""
                                            className="review_profile"
                                        />
                                        <div className="text-col3">
                                            <div className="review_name">Ernest R.</div>
                                            <div className="review_info">
                                                Editor In Chief, Journal of Indo-Pacific Affairs
                                                <br />
                                                Small-Business(50 or fewer emp.)
                                            </div>
                                        </div>
                                ...
                                <div className="reviews_card">
                                    ...
                                    <div className="text-block-93">
                                        "Super easy to use and great workflow "
                                    </div>
                                    <p className="paragraph-22">
                                        It is a great product that saves a toon of time for producing a
                                        video to either promote your product or a feature that you are
                                        working on for your project.
                                    </p>
                                    <div className="hori-between-div review">
                                        <img
                                            src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65672406316e934d6702a499_image%209.webp"
                                            alt=""
                                            className="review_profile"
                                        />
                                        <div className="text-col3">
                                            <div className="review_name">Leonardo M.</div>
                                            <div className="review_info">
                                ...
                                <div className="reviews_card">
                                    ...
                                    <div className="text-block-93">
                                        "Making a picture talk was cake and fun "
                                    </div>
                                    <p className="paragraph-22">
                                        I was able to produce a quick talking video from a photo. It was
                                        great to add a fun friendly face on-the-fly without any
                                        hand-holding required.
                                    </p>
                                    <div className="hori-between-div review">
                                        <img
                                            src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65672407a0807a9b3bbaf7d8_image%2010.webp"
                                            alt=""
                                            className="review_profile"
                                        />
                                        <div className="text-col3">
                                            <div className="review_name">Christopher S.</div>
                                            <div className="review_info">
                                ...
                                <div className="reviews_card">
                                    ...
                                    <div className="text-block-93">
                                        "When they perfect this, watch out "
                                    </div>
                                    <p className="paragraph-22">
                                        I love the user interface, they make it very simple to create
                                        short, engaging videos that have proven to be very helpful for
                                        our HR and training departments.
                                    </p>
                                    <div className="hori-between-div review">
                                        <img
                                            src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/656724075d35533da788a7b4_image%2011.webp"
                                            alt=""
                                            className="review_profile"
                                        />
                                        <div className="text-col3">
                                            <div className="review_name">John I.</div>
                                            <div className="review_info">
                                                America 's EUC Leader at DuPont
                                                <br />
                                                Small-Business(50 or fewer emp.)
                                            </div>
                                        </div>
                        ...
                        <div className="reviews_row2_wrap">
                            <div className="reviews_row_2">
                                <div className="reviews_card">
                                    ...
                                    <div className="text-block-93">"Amazing and practical "</div>
                                    <p className="paragraph-22">
                                        its ease of use, the quality of the generated videos, the
                                        variety of templates available, the speed at which it can create
                                        videos, and the affordability compared to hiring a professional
                                        video editor.
                                    </p>
                                    <div className="hori-between-div review">
                                        <img
                                            src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65672407bba078c4d063f089_image%2012.webp"
                                            alt=""
                                            className="review_profile"
                                        />
                                        <div className="text-col3">
                                            <div className="review_name">Jafer E.</div>
                                            <div className="review_info">
                                                IT Manager
                                                <br />
                                ...
                                <div className="reviews_card">
                                    ...
                                    <div className="text-block-93">
                                        "Pretty amazing, the result is too good "
                                    </div>
                                    <p className="paragraph-22">
                                        Heygen is easy, and the result and the quality is amazing, with
                                        2 min of video i get nice results
                                    </p>
                                    <div className="hori-between-div review">
                                        <img
                                            src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65672407535d110a8ddc33d8_image%2017.webp"
                                            alt=""
                                            className="review_profile"
                                        />
                                        <div className="text-col3">
                                            <div className="review_name">aaron a.</div>
                                            <div className="review_info">
                                                Creative technologist /Marketing and Advertising
                                                <br />
                                                Mid-Market(51-1000 emp.)
                                            </div>
                                        </div>
                                ...
                                <div className="reviews_card">
                                    ...
                                    <div className="text-block-93">
                                        "Save time communicating your story "
                                    </div>
                                    <p className="paragraph-22">
                                        Within seconds you an find an avatar and voice that will clearly
                                        position your message. Add your text or use AI to help you craft
                                        the perfect message and generate your video.
                                    </p>
                                    <div className="hori-between-div review">
                                        <img
                                            src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/6567240749666de08ebd4825_image%2018.webp"
                                            alt=""
                                            className="review_profile"
                                        />
                                        <div className="text-col3">
                                            <div className="review_name">Cath P.</div>
                                            <div className="review_info">
                                                CCO
                                                <br />
                                                Small-Business(50 or fewer emp.)
                                ...
                                <div className="reviews_card">
                                    ...
                                    <div className="text-block-93">
                                        "It’s one fo the best I’ve seen "
                                    </div>
                                    <p className="paragraph-22">
                                        I like that it 's user friendly and it doesn 't require a huge
                                        learning curve. I also like the customization feature and the
                                        wide spread of ethnicities available.
                                    </p>
                                    <div className="hori-between-div review">
                                        <img
                                            src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65672407cecbbe72c5ca9fcb_image%2019.webp"
                                            alt=""
                                            className="review_profile"
                                        />
                                        <div className="text-col3">
                                            <div className="review_name">Lee-ann P.</div>
                                            <div className="review_info">
                                                CEO &amp;Founder
                                                <br />
                                                Small-Business(50 or fewer emp.)
                                ...
                                <div className="reviews_card">
                                    ...
                                    <div className="text-block-93">
                                        "Crazy AI solution with great results "
                                    </div>
                                    <p className="paragraph-22">
                                        The Avatars are so realistic and the software is easy to
                                        understand and to use. I really love it and I have tons of use
                                        cases in my head.
                                    </p>
                                    <div className="hori-between-div review">
                                        <img
                                            src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65672407fc67698db8ac2d7a_image%2014.webp"
                                            alt=""
                                            className="review_profile"
                                        />
                                        <div className="text-col3">
                                            <div className="review_name">Rainer L.</div>
                                            <div className="review_info">
                                ...
                                <div className="reviews_card">
                                    ...
                                    <div className="text-block-93">"Amazing "</div>
                                    <p className="paragraph-22">
                                        I entered to create an avatar and I found a world of
                                        possibilities to delve into and discover.
                                    </p>
                                    <div className="hori-between-div review">
                                        <img
                                            src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65672406cecbbe72c5ca9f23_image%2013.webp"
                                            alt=""
                                            className="review_profile"
                                        />
                                        <div className="text-col3">
                                            <div className="review_name">Peb B.</div>
                                            <div className="review_info">
                                                Production Director
                                                <br />
                                                Mid-Market(51-1000 emp.)
                        ...
                        <div className="div-block-329">
                            ...
                            >
                                ...
                                <img
                                    ...
                                    loading="lazy"
                                    width={166}
                                    sizes="(max-width: 479px) 100vw, (max-width: 991px) 56vw, 565.7578125px"
                                    alt=""
                                ...
                                <div className="footer_avatar_video_wrap w-embed">
                                    ...
                                    <video
                                        ...
                                        src="https://resource.heygencdn.com/homepage/footer_new.mp4"
                                        type="video/mp4"
                                        muted=""
                                        autoPlay=""
                                        loop=""
                            ...
                            >
                                <div>
                                    ...
                                    <div className="footer_links_wrap">
                                        <a href="/explainer-video-maker" className="heygen_footer_link">
                                            Explainer &amp;How to
                                        </a>
                                        <a href="/marketing-videos" className="heygen_footer_link">
                                            Marketing
                                        </a>
                                        <a href="/learning-development" className="heygen_footer_link">
                                            Training &amp;Onboarding
                                        </a>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="footer_links_wrap">
                                        ...
                                        <a href="/personalized-video-3" className="heygen_footer_link">
                                            Personalized Video
                                        </a>
                                        <a href="/real-time" className="heygen_footer_link">
                                            Realtime Avatar
                                        </a>
                        ...
                        <div className="div-block-332">
                            <div className="footer_copyright">
                                <div>
                                    ...
                                    <div>12130 Millennium Drive Suite 300, Los Angeles, CA 90094</div>
                                </div>
